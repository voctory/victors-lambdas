...
| Testing | `LambdaContextStub`, `HandlerHarness`, parameter provider stub re-export, optional S3 object client stub, text/bytes fixture readers, and JSON fixture decoder | Additional fake AWS provider stubs |
...
| `aws-lambda-powertools-testing` | Test helpers | Context stubs, handler harnesses, parameter provider stubs, optional S3 object client stubs, and fixture loaders exist; expand additional fake provider stubs only as real utilities need them |
