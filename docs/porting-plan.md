...
| Data masking | `DataMasking`, whole-value erasure, field erasure by JSON Pointer, dot path, or common JSONPath-style selectors, fixed/dynamic/custom/regex masking strategies, provider encryption/decryption, optional direct AWS KMS provider, configurable missing-field behavior, initial docs/snippet, and umbrella exports | AWS Encryption SDK envelope encryption/cached data keys and advanced JSONPath operators beyond the supported selector subset |
...
| `aws-lambda-powertools-data-masking` | Data masking | Whole-value erasure, JSON Pointer, dot-path, and common JSONPath-style field masking, fixed/dynamic/custom/regex masking strategies, provider encryption/decryption, optional direct AWS KMS provider, configurable missing-field behavior, initial docs/snippet, and umbrella exports exist; next work is AWS Encryption SDK envelope encryption/cached data keys and advanced JSONPath operators beyond the supported selector subset |
