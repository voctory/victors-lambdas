...
| Streaming | `RangeSource`, `SeekableStream`, `BytesRangeSource`, optional gzip decoder, CSV reader, and ZIP archive transforms, initial docs/snippet, and umbrella exports | AWS SDK-backed S3 range source |
...
| `aws-lambda-powertools-streaming` | Seekable streaming | `RangeSource`, `SeekableStream`, local byte range source, optional gzip decoder, CSV reader, and ZIP archive transforms, initial docs/snippet, and umbrella exports exist; next work is an AWS SDK-backed S3 range source |
