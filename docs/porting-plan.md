...
- Feature flags: the umbrella crate exposes `logger`, `logger-tracing`, `metrics`, `tracer`, `tracer-opentelemetry`,
  ...
  `validation-jmespath`, `event-handler`, `event-handler-appsync-events`, `event-handler-bedrock-agent-functions`,
