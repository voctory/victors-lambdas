...
| Streaming | `RangeSource`, `SeekableStream`, `AsyncRangeSource`, `AsyncSeekableStream`, `BytesRangeSource`, `S3RangeSource`/`S3ObjectClient`/`AsyncS3ObjectClient`, optional AWS SDK-backed S3 client adapter, gzip decoder, CSV reader, and ZIP archive transforms, initial docs/snippet, and umbrella exports | Larger streaming examples |
...
| `aws-lambda-powertools-streaming` | Seekable streaming | `RangeSource`, `SeekableStream`, `AsyncRangeSource`, `AsyncSeekableStream`, local byte range source, S3 object range source abstraction, optional AWS SDK-backed S3 client adapter, gzip decoder, CSV reader, and ZIP archive transforms, initial docs/snippet, and umbrella exports exist; next work is larger streaming examples |
