...
| `aws-lambda-powertools-parser` | Event parsing | serde JSON facade plus API Gateway, ALB, SQS, SNS, EventBridge, CloudWatch Logs, Kinesis, and Firehose `aws_lambda_events` envelopes exist; broader envelope coverage and fixtures are next |
