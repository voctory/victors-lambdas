...
use aws_lambda_powertools_core::cold_start;
use aws_lambda_powertools_tracer::{TraceFields, TraceSegment, TraceValue, Tracer};
...
mod tests {
    ...
    use aws_lambda_powertools_tracer::{TraceValue, Tracer, TracerConfig};
