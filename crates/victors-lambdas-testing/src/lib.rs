//! Testing helpers for Victor's Lambdas.
...
pub use victors_lambdas_feature_flags::InMemoryFeatureFlagStore as FeatureFlagStoreStub;
#[cfg(feature = "idempotency")]
pub use victors_lambdas_idempotency::InMemoryIdempotencyStore as IdempotencyStoreStub;
pub use victors_lambdas_parameters::InMemoryParameterProvider as ParameterProviderStub;
...
mod tests {
    ...
    fn feature_flag_store_stub_evaluates_config() {
        use victors_lambdas_feature_flags::{
    ...
    fn idempotency_store_stub_keeps_records() {
        ...
        use victors_lambdas_idempotency::{IdempotencyRecord, IdempotencyStore};
