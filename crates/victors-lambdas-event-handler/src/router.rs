...
impl Router {
    ...
    pub fn add_metrics_middleware(
        &mut self,
        metrics: std::sync::Arc<std::sync::Mutex<victors_lambdas_metrics::Metrics>>,
    ) -> &mut Self {
    ...
    pub fn add_trace_middleware(
        &mut self,
        tracer: victors_lambdas_tracer::Tracer,
    ...
    pub fn add_request_validator(
        &mut self,
        validator: impl Fn(&Request) -> victors_lambdas_validation::ValidationResult
        + Send
        + Sync
        + 'static,
    ) -> &mut Self {
    ...
    pub fn add_response_validator(
        &mut self,
        validator: impl Fn(&Request, &Response) -> victors_lambdas_validation::ValidationResult
        + Send
        + Sync
        + 'static,
    ) -> &mut Self {
...
mod tests {
    ...
    use victors_lambdas_core::env;
    #[cfg(feature = "validation")]
    use victors_lambdas_validation::Validator;
