...
- serde JSON parsing facade with structured parse errors and optional `aws_lambda_events` API Gateway and ALB body, SQS,
  SNS, EventBridge, CloudWatch Logs, Kinesis, and Firehose envelopes
