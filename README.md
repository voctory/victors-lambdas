...
- serde JSON parsing facade with structured parse errors and optional `aws_lambda_events` API Gateway
  ...
  Cognito User Pool trigger aliases, Auto Scaling, AWS Config, CloudWatch Alarms, CodeCommit, SES, CloudWatch Logs,
  Kinesis, Kinesis-delivered DynamoDB stream image, Firehose, Firehose-delivered SQS, Kinesis-delivered CloudWatch Logs,
